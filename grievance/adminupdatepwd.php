...
if(!empty($_POST["pwd"]) && !empty($_POST["npwd"]) && !empty($_POST["cnpwd"])){
    ...
    $obj=new Register();
    $x=$obj->changeadmpwd($_SESSION["user1"],$_POST["pwd"],$_POST["npwd"]);
    if($x==1){
...
<form class="text-center border border-light" action="adminupdatepwd.php" method="POST" onsubmit="validate()">
