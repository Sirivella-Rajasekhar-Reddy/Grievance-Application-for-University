...
$vg=new Register();
$result=$vg->viewAllGrievByStatus("solved",$_SESSION['dept']);
...
<div class="container">
    <ul class="nav nav-tabs">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="#">Resolved</a>
      </li>
      <li class="nav-item">
...
<div class="card">
    <h4 align="center">Resolved Grievances</h4>
...
require('register.class.php');
$vg=new Register();
$result=$vg->viewAllGrievByStatusAdmin("solved");
require('adminnavbar.php');
?>
