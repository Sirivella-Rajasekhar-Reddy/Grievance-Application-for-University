...
$vg=new Register();
$result=$vg->viewAllGrievByStatus("rejected",$_SESSION['dept']);
...
<div class="container">
    <ul class="nav nav-tabs">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="#">Not Considered</a>
      </li>
    </ul>

<div class="card">
    <h4 align="center">Not Considered Grievances</h4>
...
require('register.class.php');
$vg=new Register();
$result=$vg->viewAllGrievByStatusAdmin("rejected");
require('adminnavbar.php');
?>
